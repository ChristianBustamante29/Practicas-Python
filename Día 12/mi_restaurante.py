...
aplicacion.geometry('1075x630+0+0')
...
# Etiqueta titulo
etiqueta_titulo = Label(panel_superior, text='Sistema de facturación', fg='azure4', font=('Dosis', 58), bg='burlywood', width=23)
...
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mousse', 'pastel1', 'paste2', 'pastel3']
